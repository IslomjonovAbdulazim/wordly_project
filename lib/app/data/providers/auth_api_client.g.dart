...
class _AuthApiClient implements AuthApiClient {
  ...
  @override
  Future<List<BookResponseModel>> books() async {
    ...
    late List<BookResponseModel> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) =>
                BookResponseModel.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
  ...
  Future<List<UnitResponseModel>> getUnits(int bookId) async {
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<UnitResponseModel> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) =>
                UnitResponseModel.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
