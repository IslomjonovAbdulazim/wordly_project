...
class _$RefreshRequestModelImpl implements _RefreshRequestModel {
  const _$RefreshRequestModelImpl({required this.refresh});
  ...
  @override
  String toString() {
    return 'RefreshRequestModel(refresh: $refresh)';
  }
...
abstract class _RefreshRequestModel implements RefreshRequestModel {
  const factory _RefreshRequestModel({required final String refresh}) =
